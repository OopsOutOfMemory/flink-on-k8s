...
if [ -n "${FROM_RELEASE}" ]; then
  ...
  CURL_OUTPUT="./${FLINK_DIST_FILE_NAME}"

  echo "Downloading ${FLINK_DIST_FILE_NAME} from ${FLINK_BASE_URL}"
  echo "http://mirror-hk.koddos.net/apache/flink/flink-${FLINK_VERSION}/${FLINK_DIST_FILE_NAME}" --output ${CURL_OUTPUT}
  curl -# "http://mirror-hk.koddos.net/apache/flink/flink-${FLINK_VERSION}/${FLINK_DIST_FILE_NAME}" --output ${CURL_OUTPUT}
